        ...
        <div class="row">
            <div class="card course">
             <div class="row">
                ...
                <div class="col-md-6">
                <label for="" class="form-label fs-3 text-gray">Category</label>
                <input type="text" class="form-control" name="category_name" id="" placeholder="Enter Category Name" aria-describedby="helpId">
                </div>
                <div class="col-md-12 mt-2">
                <label for="" class="form-label fs-3 text-gray">Course Description</label>
                <textarea class="form-control" rows="3" name="course_description" id="" placeholder="Enter Course Description" aria-describedby="helpId"></textarea>
                </div>
                <hr>
                <div class="col-2">
                        ...
                        <div id="collapseContent_${moduleIndex}_${countcontent}" class="accordion-collapse collapse" aria-labelledby="headingContent_${moduleIndex}_${countcontent}">
                            <div class="accordion-body" style="background-color: #1e293b;">
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-12">
                                        <label for="video_length_${moduleIndex}_${countcontent}" class="form-label fs-3 text-gray">Video Length(HH:MM:SS)</label>
                                  ...
                                  <div class="col-md-12">
                                        ...
                                        <input type="file" class="form-control" name="content[${moduleIndex}][${countcontent}][image]" id="image_${moduleIndex}_${countcontent}" placeholder="HH:MM:SS" aria-describedby="helpId" accept="image/*">
                                    </div>

                                  <div class="col-md-12">
                                        <label for="Image${moduleIndex}_${countcontent}" class="form-label fs-3 text-gray">Upload Video</label>
                                        <input type="file" class="form-control" name="content[${moduleIndex}][${countcontent}][video]" id="upload_video_length_${moduleIndex}_${countcontent}" placeholder="HH:MM:SS" aria-describedby="helpId">
                                    </div>
...
function validateForm() {
    ...
    if (category_name === '') {
        $('input[name="category_name"]').after('<span class="text-danger">Category name is required</span>');
        isvalid = false;
    }

     let course_description = $('textarea[name="course_description"]').val();
    if (course_description === '') {
        $('textarea[name="course_description"]').after('<span class="text-danger">Course description is required</span>');
        isvalid = false;
    }
